<<<<<<< HEAD
# Mira's Opinionated Kohya Trainer Fork (only supports LoRA training right now)
...
##### v0.0.3 (6/7):
__What Changes?__
- Added experimental SDXL support.
...
- Delete unnecessary default options.
- Replace NAI with fp16 pruned version.
...
## Credit
[Kohya](https://twitter.com/kohya_ss) | [Lopho](https://github.com/lopho/stable-diffusion-prune) for prune script | Just for my part
>>>>>>> c982eb8ea5d2a85f4db30c1128d039f4613fc29a
